...
`@sigx/live-code` is in early public release. Security fixes are applied to the latest `0.1.x` line.
...
1. **GitHub Security Advisories** — preferred. Open a private report at
   <https://github.com/signalxjs/live-code/security/advisories/new>.
