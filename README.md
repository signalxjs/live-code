...
Live, executable code blocks for [sigx](https://sigx.dev/core/) documentation. Renders a Monaco editor next to a sandboxed preview that runs your sigx components in real time, with TypeScript/JSX compilation done in-browser via [sucrase](https://github.com/alangpierce/sucrase).
