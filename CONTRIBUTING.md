...
Thanks for your interest! This repo ships [`@sigx/live-code`](./packages/monaco-editor) — a pluggable Monaco editor wrapper for [sigx](https://github.com/signalxjs/core). Other SignalX packages (router, store, UI kit, SSG, docs site) live in their own repositories under [`signalxjs`](https://github.com/signalxjs).
...
cd monaco-editor
pnpm install
pnpm --filter @sigx/live-code bundle:monaco
pnpm build
```
